...
namespace Entitas {
    ...
    public partial class Entity {
        ...
        public BundleDrop.PositionComponent position { get { return (BundleDrop.PositionComponent)GetComponent(CoreComponentIds.Position); } }
        public bool hasPosition { get { return HasComponent(CoreComponentIds.Position); } }

        public Entity AddPosition(float newX, float newY) {
            var component = CreateComponent<BundleDrop.PositionComponent>(CoreComponentIds.Position);
            component.x = newX;
            component.y = newY;
